  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-cosmic-800/50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/" className="flex items-center gap-2 font-bold text-xl">
              ...
              <span className="hidden sm:inline-block glow-text">
                IA & Enseignement
              </span>
            </Link>
            ...
            <button
              ...
              className="group relative flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition-all duration-300 text-muted-foreground hover:text-foreground hover:bg-cosmic-900/30 border border-transparent hover:border-cosmic-700/50"
            ...
            >
              ...
              <span className="hidden lg:inline-block text-xs">Animation</span>
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-cosmic-800/50 animate-in slide-in-from-top duration-200">
