...
function initModes() {
    ...
    if (animationRenderer && typeof SCENES !== 'undefined') {
        ...
        // Initialiser le gestionnaire de scenes
        ...
        timeline = Timeline.init(sceneManager.getScenesForTimeline(), {
            onTimeUpdate: (currentTime, sceneData) => {
                // Effacer l'overlay MathJax au debut de chaque frame
                if (typeof MathOverlay !== 'undefined') {
                    MathOverlay.clear();
                }
                ...
                // Verifier si la scene actuelle desactive la grille/axes
            ...
            onSceneChange: (sceneData) => {
                ...
                // Effacer l'overlay MathJax lors du changement de scene
                if (typeof MathOverlay !== 'undefined') {
                    MathOverlay.clear();
                }
            }
